...
class Face_Recognition_System:
    def __init__(self,root):
        ...
        img=Image.open(r"C:\Users\Muhammad Zohaib\Documents\4rth S\TPL\face recog\face recog\college_images\Superior-University.png")
       ...
       #1
        ...
        img2=Image.open(r"C:\Users\Muhammad Zohaib\Documents\4rth S\TPL\face recog\face recog\college_images\student.png")
        ...
        b1_1 = Button(self.root, text="STUDENT DETAILS", cursor="hand2", font=("times new roman", 12, "bold"), bg="#000066", fg="white")
        b1_1.place(x=200,y=355,width=180,height=40)
    

        #face recognition
        #2
        img3=Image.open(r"C:\Users\Muhammad Zohaib\Documents\4rth S\TPL\face recog\face recog\college_images\facerecognition.webp")
        ...
        b1_1 = Button(self.root, text="FACE DETECTOR", cursor="hand2", font=("times new roman", 15, "bold"), bg="#000066", fg="white")
        b1_1.place(x=440,y=355,width=180,height=40)

        #ATTENDENCE
        #3
        img4=Image.open(r"C:\Users\Muhammad Zohaib\Documents\4rth S\TPL\face recog\face recog\college_images\attendence.webp")
        ...
        b1_1 = Button(self.root, text="ATTENDENCE", cursor="hand2", font=("times new roman", 15, "bold"), bg="#000066", fg="white")
        b1_1.place(x=680,y=355,width=180,height=40)

        #CONTACT US
        #4
        img5=Image.open(r"C:\Users\Muhammad Zohaib\Documents\4rth S\TPL\face recog\face recog\college_images\help.webp")
        ...
        b1_1 = Button(self.root, text="HELP", cursor="hand2", font=("times new roman", 15, "bold"), bg="#000066", fg="white")
        b1_1.place(x=920,y=355,width=180,height=40)

       #---------------------------------------------------------------------------------------------------------------------------------------------------------
       #TRAIN DATA
       #5
        img6=Image.open(r"C:\Users\Muhammad Zohaib\Documents\4rth S\TPL\face recog\face recog\college_images\traindata.jpg")
        ...
        b1_1 = Button(self.root, text="TRAIN DATA", cursor="hand2", font=("times new roman", 12, "bold"), bg="#000066", fg="white")
        b1_1.place(x=200,y=570,width=180,height=40)

       #PHOTOS
       #6
        img7=Image.open(r"C:\Users\Muhammad Zohaib\Documents\4rth S\TPL\face recog\face recog\college_images\photos.jpg")
        ...
        b1_1 = Button(self.root, text="PHOTOS", cursor="hand2", font=("times new roman", 12, "bold"), bg="#000066", fg="white")
        b1_1.place(x=440,y=570,width=180,height=40)

       #DEVELOPER
       #7
        img8=Image.open(r"C:\Users\Muhammad Zohaib\Documents\4rth S\TPL\face recog\face recog\college_images\developer.png")
       ...
       #8
        ...
        b1_1 = Button(self.root, text="EXIT", cursor="hand2", font=("times new roman", 12, "bold"), bg="#000066", fg="white")
